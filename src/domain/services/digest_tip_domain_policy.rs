//! Domain policy for DigestTip aggregate
//!
...
/// Domain policy for DigestTip — permits all operations (no business invariants).
///
...
/// enforcement, implement `backbone_core::ServiceLifecycle<DigestTip>` on a custom
/// service. `PermitAllPolicy` is the safe default until then.
pub type DigestTipDomainPolicy = PermitAllPolicy<DigestTip>;
