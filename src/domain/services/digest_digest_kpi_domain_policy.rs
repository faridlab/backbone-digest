//! Domain policy for DigestDigestKpi aggregate
//!
...
/// Domain policy for DigestDigestKpi — permits all operations (no business invariants).
///
...
/// enforcement, implement `backbone_core::ServiceLifecycle<DigestDigestKpi>` on a custom
/// service. `PermitAllPolicy` is the safe default until then.
pub type DigestDigestKpiDomainPolicy = PermitAllPolicy<DigestDigestKpi>;
