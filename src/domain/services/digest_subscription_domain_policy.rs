//! Domain policy for DigestSubscription aggregate
//!
...
/// Domain policy for DigestSubscription — permits all operations (no business invariants).
///
...
/// enforcement, implement `backbone_core::ServiceLifecycle<DigestSubscription>` on a custom
/// service. `PermitAllPolicy` is the safe default until then.
pub type DigestSubscriptionDomainPolicy = PermitAllPolicy<DigestSubscription>;
