//! Specifications for DigestTipUser aggregate
//!
...
// Each predicate implements `Specification<DigestTipUser>` and can be combined
...
//
// pub struct ActiveDigestTipUserSpec;
// impl Specification<DigestTipUser> for ActiveDigestTipUserSpec {
//     fn is_satisfied_by(&self, e: &DigestTipUser) -> bool {
//         // e.is_active
//         todo!()
//     }
// }
