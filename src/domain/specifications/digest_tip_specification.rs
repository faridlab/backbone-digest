//! Specifications for DigestTip aggregate
//!
...
// Each predicate implements `Specification<DigestTip>` and can be combined
...
//
// pub struct ActiveDigestTipSpec;
// impl Specification<DigestTip> for ActiveDigestTipSpec {
//     fn is_satisfied_by(&self, e: &DigestTip) -> bool {
//         // e.is_active
//         todo!()
//     }
// }
