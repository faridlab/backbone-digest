...
--
-- This file contains initial seed data for the digest.digest_tips table.
-- Customize this file to add your initial data.

-- INSERT INTO digest.digest_tips (
--     id,
--     sequence,
--     name,
--     tip_description,
...
-- INSERT INTO digest.digest_tips (id, code, name, is_active, created_at, updated_at) VALUES
